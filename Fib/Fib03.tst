// Test case for large number (couldn't run on local machine takes way too long)
...
repeat 2000000 {        // Change this number to cover the number of instructions in the VM test file
  vmstep;
}
